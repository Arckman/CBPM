...
import org.jbpm.bpel.frj.interanalysis.modeling.model.basic.Empty;
...
public class EmptyReader extends ActivityReader {
	...
	public Activity read(Element element, CompositeActivity parent) {
		...
		//set property
		setProperty(element,empty,parent);
		//set links
		setConnection(element,empty,parent);
