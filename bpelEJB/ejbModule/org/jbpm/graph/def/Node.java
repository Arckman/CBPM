    ...
    if (action!=null) {
      try {
    	  ...
    	  if(this instanceof Wait)
    		  System.out.println(executionContext.getProcessDefinition().getName()+":"+executionContext.getProcessInstance().getId()+" starting waiting for a "+action.toString()+" duration...");
    	  else if(this instanceof Reply){
