...
<table>
<tr><td>Input Process Name</td><td><input type="text" name="processName"/></td></tr>
<tr><td>Input Activity Name</td><td><input type="text" name="activityName"/></td></tr>
<tr><td>Input Stop Activity</td><td><input type="text" name="stopActivity"></td></tr>
